...
export default function ActivityCard({ data }: ActivityCardProps) {
  ...
  return (
    <Link href={`/${currentLocale}/home/trip/${data?.id}`}>
        ...
        <div className="pt-3 pb-4 px-2 space-y-2">
          ...
          <div className="flex justify-between items-center">
            ...
            <div className="flex justify-between items-center gap-1">
              ...
              <span className="text-(--primary) text-xs">{typeof data?.destination === "object" && data?.destination !== null && "title" in data.destination
